...
// Help
$_['help_key']                     = 'Introduzca la clave de acceso XML tarifas asignada a usted por UPS.';
$_['help_username']                = 'Ingrese su cuenta servicios de UPS.';
$_['help_password']                = 'Introduzca su contraseña de cuenta de servicios de UPS.';
$_['help_pickup']                  = '¿Cómo das paquetes de UPS (sólo se utiliza cuando el origen es Estados Unidos)?';
$_['help_packaging']               = '¿Qué tipo de embalaje usas?';
$_['help_classification']          = '01 - Si usted está facturando a una cuenta UPS y tiene una camioneta UPS diario, 03 - Si usted no tiene una cuenta UPS o está facturando a una cuenta UPS pero no tiene una recolección diaria, 04 - Si usted va a enviar desde un punto de venta (sólo se utiliza cuando el origen es Estados Unidos)';
$_['help_origin']                  = 'Punto de origen de lo que debería ser utilizada (esta configuración afecta a sólo los nombres de productos que UPS se muestran al usuario)';
$_['help_city']                    = 'Introduzca el nombre de la ciudad de origen.';
$_['help_state']                   = 'Introduzca el código de dos letras de su estado/provincia de origen.';
$_['help_country']                 = 'Introduzca el código de dos letras de su país de origen.';
$_['help_postcode']                = 'Introduzca su origen zip/código postal.';
$_['help_test']                    = '¿Utilice este módulo en modo de prueba (sí) o producción (NO)?';
$_['help_quote_type']              = 'Cita para la entrega residencial o comercial.';
$_['help_service']                 = 'Selecciona los servicios de UPS que se ofrecerán.';
$_['help_insurance']               = 'Permite seguro con total como el valor del producto';
$_['help_display_weight']          = '¿Quieres mostrar el peso del envío? (e.g. entrega peso: 2,7674 kg)';
$_['help_weight_class']            = 'Establezca en kilogramos o libras.';
$_['help_length_class']            = 'Establezca en centímetros o pulgadas.';
$_['help_dimension']			   = 'Esto se supone que su promedio de tamaño de la caja de embalaje. Dimensiones del elemento individual no son compatibles en este momento así que debes introducir dimensiones promedio como 5 x 5 x 5.';
