...
$_['text_ip_message']				= 'Debe proporcionar su dirección IP del servidor a su Gerente de cuenta Realex antes de salir vivo';
...
$_['entry_tss_check']				= 'TSS cheques';
$_['entry_card_data_status']		= 'Información de registro de tarjeta';
$_['entry_3d']						= 'Habilitar 3D secure';
...
$_['entry_status_decline_pending']	= 'Rechazar - auth offline';
$_['entry_status_decline_stolen']	= 'Rechazar - tarjeta perdida o robada';
$_['entry_status_decline_bank']		= 'Rechazar - error del Banco';
...
$_['help_notification']				= 'Debe proporcionar esta URL a Realex obtener notificaciones de pago';
$_['help_debug']					= 'Activar depuración escribirá los datos confidenciales en un archivo de registro. Siempre deberá desactivar a menos instruya lo contrario.';
$_['help_liability']				= 'Aceptando responsabilidad significa que todavía va a aceptar los pagos cuando un usuario falla 3D secure.';
$_['help_card_data_status']			= 'Registra los últimos 4 dígitos de la tarjeta, expirar, nombre, información de tipo y el banco emisor';
...
$_['error_secret']					= 'Secreto compartido se requiere';