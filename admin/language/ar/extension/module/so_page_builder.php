...
$_['heading_title_so_']    	= 'So Page Builder <b style="font-size:10px; background:#aaa; color:#fff; padding: 3px;font-weight:normal">version 1.1.1</b>';
...
$_['text_medium_col_'] 					= '<b>Medium Devices, Desktops</b><br><i style="font-size:10px">(For devices have screen width from >= 992px to < 1200px.)</i>';
$_['text_small_col_'] 					= '<b>Small Devices, Tablets</b><br><i style="font-size:10px">(For devices have screen width from >= 768px to < 992px.)</i>';
