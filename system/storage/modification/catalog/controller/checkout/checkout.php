        ...
        /* xml */
                ...
                public function shipping($return = false) {
                    ...
                    if ($return) {
                        ...
                        $this->response->setOutput($this->load->view('extension/module/so_onepagecheckout/checkout/shipping_methods', $data));
                    }
                }
                ...
                public function payment($return = false) {
                    ...
                    if ($return) {
                        ...
                        $this->response->setOutput($this->load->view('extension/module/so_onepagecheckout/checkout/payment_methods', $data));
                    }
                }
                ...
                public function cart($return = false) {
                    ...
                    if ($return) {
                        ...
                        $this->response->setOutput($this->load->view('extension/module/so_onepagecheckout/checkout/cart', $data));
                    }
                }

                public function cart_update() {
                    $key = $this->getProperty($this->request->post, 'key');
                ...
                private function getAddressData($array, $key = '', $prefix = '') {
                    ...
                    foreach ($keys as $k) {
                        $result[$prefix . $k] = $this->getProperty($array, $key . $k, '');
                    }
                    ...
                    $result[$prefix . 'custom_field'] = $this->getProperty($array, $key . 'custom_field', array());
